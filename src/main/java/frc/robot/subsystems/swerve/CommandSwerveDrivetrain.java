...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
    ...
    public Command followpathfinderpath(Pose2d targetPose) {
        return AutoBuilder.pathfindToPose(
                targetPose,
                new PathConstraints(0.4, 2.0, Units.degreesToRadians(540), Units.degreesToRadians(720)),
                0.0);
    }

    public PathPlannerPath pathfromfile(String pathName) {
        try {
